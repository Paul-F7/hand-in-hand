...
import { CheckCircle, XCircle, ChevronDown, ChevronUp, Video, MessageSquare, Trophy, RotateCcw, ArrowRight, Home } from 'lucide-react';
        ...
        <div className="flex flex-col gap-4">
          ...
          {onReturnHome && (
            <button
              ...
              className="w-full bg-slate-800/50 hover:bg-slate-700/50 text-slate-300 hover:text-white px-8 py-4 rounded-xl font-semibold text-base transition shadow-lg flex items-center justify-center gap-2 border-2 border-slate-700 hover:border-slate-600"
            >
